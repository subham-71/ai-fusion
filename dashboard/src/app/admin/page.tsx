  ...
  return (
    <div className="grid min-h-screen items-start gap-4 px-4 md:items-center md:px-10 lg:gap-8">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-semibold">Drone Delivery Admin</h1>
      </div>
      <div className="grid gap-4">
          ...
          <CardContent className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <div className="text-sm">
                ...
                <p>Monitor delivery status, flight logs, and performance metrics.</p>
              </div>
            </div>
            <CardContent>
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>bjohnson@example.com</TableCell>
                  <TableCell>User</TableCell>
                  <TableCell>
                    <Button>Edit</Button>
                  </TableCell>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-medium">Incident Reporting</CardTitle>
          ...
          <CardContent className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <div className="text-sm">
                ...
                <p>Update content, manage databases, and ensure data integrity.</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div className="text-sm">
                ...
                <p>Implement and maintain security protocols for the system.</p>
              </div>
            </div>
          </CardContent>
        </Card>
